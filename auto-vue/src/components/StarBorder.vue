...
@media (max-width: 820px) {
  ...
  .button-content {
    ...
    font-size: 0.7rem;
    border-radius: 35px;
    margin-top: 4px; /* Más cerca de los párrafos */
  }
...
@media (max-width: 768px) {
  ...
  .button-content {
    ...
    font-size: 0.6rem;
    border-radius: 30px;
    margin-top: 3px; /* Más cerca de los párrafos */
  }
...
@media (max-width: 480px) {
  ...
  .button-content {
    ...
    font-size: 0.5rem;
    border-radius: 25px;
    margin-top: 2px; /* Más cerca de los párrafos */
  }
...
@media (max-width: 395px) {
  ...
  .button-content {
    ...
    font-size: 0.4rem;
    border-radius: 20px;
    margin-top: 1px; /* Más cerca de los párrafos */
  }
